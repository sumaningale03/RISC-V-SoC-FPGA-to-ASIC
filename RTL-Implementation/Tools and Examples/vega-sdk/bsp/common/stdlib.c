...
@brief Millisecond accurate delay for ARIES board
@param[in] micro seconds
@return int
*/
#define SYS_FREQ_MHZ 75000000
int accurate_udelay(unsigned int microsec)

{
        loop_count=((SYS_FREQ_MHZ/3)*microsec);       
